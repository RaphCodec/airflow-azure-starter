...
def example_python_decorator():
    ...
    # Changed to a generic logging task not requiring a SQL file
    @task(task_id="log_message")
    def log_message():
        log.info("This is a generic log message from the Python task decorator.")

    log_the_message = log_message()
    ...
    for i in range(5):
        ...
        run_this >> log_the_message >> sleeping_task
